...
CREATE TABLE `agent_activity_logs` (
  ...
  `context_accessed` json DEFAULT NULL,
  `workflow_state_id` bigint unsigned DEFAULT NULL,
  ...
  KEY `agent_activity_logs_workflow_state_id_foreign` (`workflow_state_id`),
  ...
  CONSTRAINT `agent_activity_logs_workflow_state_id_foreign` FOREIGN KEY (`workflow_state_id`) REFERENCES `agent_workflow_states` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `agent_configurations` (
  ...
  `can_modify_deliverables` tinyint(1) NOT NULL DEFAULT '0',
  `can_access_financial_data` tinyint(1) NOT NULL DEFAULT '0',
  `can_modify_playbooks` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `tool_permissions` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `agent_memories` (
  ...
  `scope` enum('project','client','org') COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `agent_memories_ai_agent_id_foreign` (`ai_agent_id`),
  KEY `agent_memories_scope_lookup` (`team_id`,`scope`,`scope_type`,`scope_id`,`key`),
  KEY `agent_memories_team_id_ai_agent_id_index` (`team_id`,`ai_agent_id`),
  KEY `agent_memories_expires_at_index` (`expires_at`),
  CONSTRAINT `agent_memories_ai_agent_id_foreign` FOREIGN KEY (`ai_agent_id`) REFERENCES `ai_agents` (`id`) ON DELETE SET NULL,
  CONSTRAINT `agent_memories_team_id_foreign` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `agent_templates` (
  ...
  `default_instructions` text COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `agent_templates_code_unique` (`code`),
  KEY `agent_templates_code_index` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `agent_workflow_states`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `agent_workflow_states` (
  ...
  `team_id` bigint unsigned NOT NULL,
  `ai_agent_id` bigint unsigned NOT NULL,
  `workflow_class` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `current_node` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `approvable_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approvable_id` bigint unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `agent_workflow_states_team_id_index` (`team_id`),
  KEY `agent_workflow_states_ai_agent_id_index` (`ai_agent_id`),
  KEY `workflow_states_status_lookup` (`team_id`,`ai_agent_id`,`completed_at`),
  KEY `workflow_states_approvable_index` (`approvable_type`,`approvable_id`),
  CONSTRAINT `agent_workflow_states_ai_agent_id_foreign` FOREIGN KEY (`ai_agent_id`) REFERENCES `ai_agents` (`id`) ON DELETE CASCADE,
  CONSTRAINT `agent_workflow_states_team_id_foreign` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ai_agents` (
  ...
  KEY `ai_agents_template_id_foreign` (`template_id`),
  CONSTRAINT `ai_agents_template_id_foreign` FOREIGN KEY (`template_id`) REFERENCES `agent_templates` (`id`) ON DELETE SET NULL
...
CREATE TABLE `document_annotations` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `document_annotations_created_by_id_foreign` (`created_by_id`),
  KEY `document_annotations_document_id_page_index` (`document_id`,`page`),
  KEY `document_annotations_communication_thread_id_index` (`communication_thread_id`),
  CONSTRAINT `document_annotations_communication_thread_id_foreign` FOREIGN KEY (`communication_thread_id`) REFERENCES `communication_threads` (`id`) ON DELETE CASCADE,
  CONSTRAINT `document_annotations_created_by_id_foreign` FOREIGN KEY (`created_by_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `document_annotations_document_id_foreign` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `document_share_accesses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `document_share_accesses` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `document_share_link_id` bigint unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `document_share_accesses_document_share_link_id_index` (`document_share_link_id`),
  CONSTRAINT `document_share_accesses_document_share_link_id_foreign` FOREIGN KEY (`document_share_link_id`) REFERENCES `document_share_links` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `document_share_links` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `document_share_links_token_unique` (`token`),
  KEY `document_share_links_created_by_id_foreign` (`created_by_id`),
  KEY `document_share_links_document_id_index` (`document_id`),
  CONSTRAINT `document_share_links_created_by_id_foreign` FOREIGN KEY (`created_by_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `document_share_links_document_id_foreign` FOREIGN KEY (`document_id`) REFERENCES `documents` (`id`) ON DELETE CASCADE
...
CREATE TABLE `folders` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `folders_created_by_id_foreign` (`created_by_id`),
  KEY `folders_team_id_index` (`team_id`),
  KEY `folders_project_id_index` (`project_id`),
  KEY `folders_parent_id_index` (`parent_id`),
  KEY `folders_team_id_project_id_index` (`team_id`,`project_id`),
  CONSTRAINT `folders_created_by_id_foreign` FOREIGN KEY (`created_by_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `folders_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `folders` (`id`) ON DELETE CASCADE,
  CONSTRAINT `folders_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
  CONSTRAINT `folders_team_id_foreign` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `global_ai_settings` (
  ...
  `require_approval_external_sends` tinyint(1) NOT NULL DEFAULT '1',
  `require_approval_financial` tinyint(1) NOT NULL DEFAULT '1',
  `require_approval_contracts` tinyint(1) NOT NULL DEFAULT '1',
  `require_approval_scope_changes` tinyint(1) NOT NULL DEFAULT '1',
  `pm_copilot_auto_suggest` tinyint(1) NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `inbox_items` (
  ...
  KEY `inbox_items_approvable_type_approvable_id_index` (`approvable_type`,`approvable_id`),
  KEY `inbox_items_related_task_id_index` (`related_task_id`),
  KEY `inbox_items_reviewer_id_index` (`reviewer_id`),
  ...
  CONSTRAINT `inbox_items_related_task_id_foreign` FOREIGN KEY (`related_task_id`) REFERENCES `tasks` (`id`) ON DELETE SET NULL,
  ...
  CONSTRAINT `inbox_items_reviewer_id_foreign` FOREIGN KEY (`reviewer_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `message_mentions` (
  ...
  PRIMARY KEY (`id`),
  KEY `message_mentions_message_id_index` (`message_id`),
  KEY `message_mentions_mentionable_index` (`mentionable_type`,`mentionable_id`),
  CONSTRAINT `message_mentions_message_id_foreign` FOREIGN KEY (`message_id`) REFERENCES `messages` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `message_reactions` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `message_reactions_unique` (`message_id`,`user_id`,`emoji`),
  KEY `message_reactions_message_id_index` (`message_id`),
  KEY `message_reactions_user_id_index` (`user_id`),
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `project_user_rates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `project_user_rates` (
  ...
  `project_id` bigint unsigned NOT NULL,
  `user_id` bigint unsigned NOT NULL,
  `internal_rate` decimal(10,2) NOT NULL,
  `billing_rate` decimal(10,2) NOT NULL,
  `effective_date` date NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `project_user_rates_project_id_user_id_effective_date_unique` (`project_id`,`user_id`,`effective_date`),
  KEY `project_user_rates_project_id_index` (`project_id`),
  KEY `project_user_rates_user_id_index` (`user_id`),
  KEY `project_user_rates_effective_date_index` (`effective_date`),
  CONSTRAINT `project_user_rates_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
  CONSTRAINT `project_user_rates_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `projects` (
  ...
  `budget_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `budget_cost` decimal(12,2) DEFAULT NULL,
...
CREATE TABLE `status_transitions` (
  ...
  `action_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'status_change',
  `user_id` bigint unsigned NOT NULL,
  ...
  `from_assigned_to_id` bigint unsigned DEFAULT NULL,
  `to_assigned_to_id` bigint unsigned DEFAULT NULL,
  `from_assigned_agent_id` bigint unsigned DEFAULT NULL,
  `to_assigned_agent_id` bigint unsigned DEFAULT NULL,
  ...
  KEY `status_transitions_from_assigned_to_id_foreign` (`from_assigned_to_id`),
  KEY `status_transitions_to_assigned_to_id_foreign` (`to_assigned_to_id`),
  KEY `status_transitions_from_assigned_agent_id_foreign` (`from_assigned_agent_id`),
  KEY `status_transitions_to_assigned_agent_id_foreign` (`to_assigned_agent_id`),
  KEY `status_transitions_action_type_index` (`action_type`),
  CONSTRAINT `status_transitions_from_assigned_agent_id_foreign` FOREIGN KEY (`from_assigned_agent_id`) REFERENCES `ai_agents` (`id`) ON DELETE SET NULL,
  CONSTRAINT `status_transitions_from_assigned_to_id_foreign` FOREIGN KEY (`from_assigned_to_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `status_transitions_to_assigned_agent_id_foreign` FOREIGN KEY (`to_assigned_agent_id`) REFERENCES `ai_agents` (`id`) ON DELETE SET NULL,
  CONSTRAINT `status_transitions_to_assigned_to_id_foreign` FOREIGN KEY (`to_assigned_to_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `tasks` (
  ...
  `position_in_work_order` int NOT NULL DEFAULT '0',
  ...
  KEY `tasks_reviewer_id_index` (`reviewer_id`),
  KEY `tasks_assigned_agent_id_index` (`assigned_agent_id`),
  KEY `tasks_work_order_id_position_in_work_order_index` (`work_order_id`,`position_in_work_order`),
  CONSTRAINT `tasks_assigned_agent_id_foreign` FOREIGN KEY (`assigned_agent_id`) REFERENCES `ai_agents` (`id`) ON DELETE SET NULL,
  CONSTRAINT `tasks_assigned_to_id_foreign` FOREIGN KEY (`assigned_to_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  CONSTRAINT `tasks_created_by_id_foreign` FOREIGN KEY (`created_by_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `time_entries` (
  ...
  `calculated_cost` decimal(12,2) DEFAULT '0.00',
...
CREATE TABLE `user_rates` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_rates_team_id_user_id_effective_date_unique` (`team_id`,`user_id`,`effective_date`),
  KEY `user_rates_team_id_index` (`team_id`),
  KEY `user_rates_user_id_index` (`user_id`),
  KEY `user_rates_effective_date_index` (`effective_date`),
  CONSTRAINT `user_rates_team_id_foreign` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE,
  CONSTRAINT `user_rates_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `work_order_lists`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `work_order_lists` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `team_id` bigint unsigned NOT NULL,
  `project_id` bigint unsigned NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `work_order_lists_project_id_position_index` (`project_id`,`position`),
  KEY `work_order_lists_team_id_project_id_index` (`team_id`,`project_id`),
  CONSTRAINT `work_order_lists_project_id_foreign` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
  CONSTRAINT `work_order_lists_team_id_foreign` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `work_orders` (
  ...
  `position_in_list` int unsigned NOT NULL DEFAULT '0',
  `assigned_to_id` bigint unsigned DEFAULT NULL,
  `created_by_id` bigint unsigned NOT NULL,
  `accountable_id` bigint unsigned NOT NULL,
  `responsible_id` bigint unsigned DEFAULT NULL,
  ...
  KEY `work_orders_work_order_list_id_position_in_list_index` (`work_order_list_id`,`position_in_list`),
  ...
  CONSTRAINT `work_orders_work_order_list_id_foreign` FOREIGN KEY (`work_order_list_id`) REFERENCES `work_order_lists` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `workflow_customizations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `workflow_customizations` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `workflow_customizations_team_id_workflow_class_unique` (`team_id`,`workflow_class`),
  KEY `workflow_customizations_team_id_index` (`team_id`),
  CONSTRAINT `workflow_customizations_team_id_foreign` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
