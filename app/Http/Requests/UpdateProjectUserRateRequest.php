...
class UpdateProjectUserRateRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'internal_rate' => ['sometimes', 'required', 'numeric', 'min:0', 'regex:/^\d+(\.\d{1,2})?$/'],
            'billing_rate' => ['sometimes', 'required', 'numeric', 'min:0', 'regex:/^\d+(\.\d{1,2})?$/'],
