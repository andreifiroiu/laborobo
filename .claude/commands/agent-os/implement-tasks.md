...
PHASE 2: Delegate implementation to one of the implementer subagents - laravel-backend-specialist, frontend-developer, database-performance-optimizer or testing-quality-engineer.
...
**If the user HAS provided instructions:** Proceed to PHASE 2 to delegate implementation of those specified task group(s) to one of the implementer subagents - **laravel-backend-specialist**, **frontend-developer**, **database-performance-optimizer** or **testing-quality-engineer**.
...
Delegate to to one of the implementer subagents - **laravel-backend-specialist**, **frontend-developer**, **database-performance-optimizer** or **testing-quality-engineer** to implement the specified task group(s):
